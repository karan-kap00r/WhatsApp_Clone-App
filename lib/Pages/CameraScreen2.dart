...
import 'package:chat_app/Pages/CameraViewPage2.dart';
// import 'package:chat_app/Screens/CameraView.dart';
import 'package:chat_app/Screens/VideoViewPage.dart';
import 'package:flutter/material.dart';
//
// late List<CameraDescription> _cameras2;
//
...
late List<CameraDescription> cameras;
  ...
  void takePhoto(BuildContext context) async {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (builder) => CameraViewPage2(
              path: file.path,
            )));
  }
}